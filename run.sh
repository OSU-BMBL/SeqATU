...
# Run bwa
	#1：sequence_ecoli_NCBI.fasta； 2：Condition1_R1.fastq；3：Condition1_R2.fastq   4: Condition1.sam
		
bwa-0.7.17/bwa index -a bwtsw $1
bwa-0.7.17/bwa aln $1 $2 > R1.sai
bwa-0.7.17/bwa aln $1 $3 > R2.sai
bwa-0.7.17/bwa sampe -f $4  $1 R1.sai R2.sai $2 $3
cd ..
